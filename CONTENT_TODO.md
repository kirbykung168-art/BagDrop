...
|---|---|---|---|
| `paymentTiming` | First hour paid at drop-off; extra time on collection | Home journey step 02; How it works step 02 and the terminal's payment screen; Legal §1 | The confirmed billing moment(s) from the payment provider set-up |
